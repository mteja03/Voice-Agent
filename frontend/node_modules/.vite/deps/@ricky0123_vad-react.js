...
var require_dist2 = __commonJS({
  "node_modules/@ricky0123/vad-react/dist/index.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function useMicVAD(options) {
      ...
      const pause = (0, react_1.useCallback)(async () => {
        if (!loading && !errored) {
          await (vad == null ? void 0 : vad.pause());
          setListening(false);
        }
      }, [loading, errored, vad]);
      const start = (0, react_1.useCallback)(async () => {
        if (!loading && !errored) {
          await (vad == null ? void 0 : vad.start());
          setListening(true);
        }
      }, [loading, errored, vad]);
